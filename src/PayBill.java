...
public class PayBill extends JFrame implements ActionListener {
    ...
    PayBill(String meter) {
        ...
        try {
            ...
            String query1 = ("select * from bill where meter_no = '" + meter + "' AND month = 'January'");
        ...
        cmonth.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent ae) {
                try {
                    Conn c = new Conn();
                    Connection connection = Conn.establishConnection();
                    String query2 = ("select * from bill where meter_no = '" + meter + "' AND month = '" + cmonth.getSelectedItem() + "'");
                    Statement st = connection.createStatement();
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == pay) {
            try {
                ...
                String query2 = ("update bill set status = 'Paid' where meter_no = '" + meter + "' AND month='" + cmonth.getSelectedItem() + "'");
